...
const char* leftBarText = "MarchingCubes Generated Model";
const char* rightBarText = "Model After Isotropic Remeshing";
...
TestMarchingCubes::TestMarchingCubes(GLFWwindow* window)
{
	...
	// 在windows上加载微软雅黑字体，支持中文显示（有问题，暂时注释掉）
    //io.Fonts->AddFontFromFileTTF("../resources/fonts/msyh.ttc", 18.0f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
...
void TestMarchingCubes::onImGuiRender()
{
            ...
            ImGuiWindowFlags_NoCollapse;
    {
        ...
        ImGui::Begin("Control Panel", nullptr, controlPanelFlag);

        ImGui::Checkbox("Line Mode", &m_lineMode);

        ImGui::Checkbox("Rotate", &m_isModelRotate);
        ImGui::End();
